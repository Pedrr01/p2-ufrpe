public class Chapters {
    ...
    public Chapters(String[] escolhas) {
    ...
    public void futuro() {
        System.out.println("Anakin, curioso e tendo esperança de mudar a sociedade, decidiu usar o dispositivo" 
    ...
    public void passado() {
        System.out.println("Anakin pensou cuidadosamente sobre sua escolha, consciente de que viajar para o passado"
    ...
    public void intervir() {
        System.out.println("Impulsionado por seu senso de justiça e determinação, Anakin decidiu intervir e tentar" 
    ...
    public void naointervir() {
        System.out.println("Apesar de sentir uma forte vontade de intervir e tentar impedir a criação do Império,"
